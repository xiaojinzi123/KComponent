...
@RouterAnno(
    hostAndPath = RouterConfig.SUPPORT_WEB_TEST,
)
@ViewLayer
class WebTestAct : BaseActivity<WebTestViewModel>() {

    override fun getViewModelClass(): Class<WebTestViewModel> {
        return WebTestViewModel::class.java
    }
