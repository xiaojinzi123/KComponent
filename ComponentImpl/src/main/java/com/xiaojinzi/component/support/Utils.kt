...
fun Exception.toNavigationException(): NavigationException {
    return when (this) {
        is NavigationException -> this
        else -> {
            NavigationException(cause = this)
        }
    }
}
...
object Utils {
    ...
    @JvmOverloads
    fun checkStringNullPointer(
        value: String?, parameterName: String, desc: String? = null
    ): String {
