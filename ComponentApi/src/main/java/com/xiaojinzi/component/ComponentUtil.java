...
public class ComponentUtil {
    ...
    public static final String PARAMETERANNO_CLASS_NAME = "com.xiaojinzi.component.anno.router.ParameterAnno";
    ...
    public static String genDefaultHostModuleApplicationClassName(String host) {
        return APPLICATION_PACKAGE + DOT + transformHostForClass(host) + MODULE_APPLCATION_DEFAULT;
    }
